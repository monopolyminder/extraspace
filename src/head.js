...
/* First two homepage visits: play the full hero intro (headline builds,
...
(function () {
  try {
    ...
    if (isHome) {
      var seen = parseInt(localStorage.getItem('intro-seen') || '0', 10);
      if (seen < 2) {
        document.documentElement.classList.add('intro');
        localStorage.setItem('intro-seen', String(seen + 1));
        return;
      }
    }
